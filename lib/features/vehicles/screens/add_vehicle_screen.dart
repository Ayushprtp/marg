  ...
  Widget _buildStep2() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 40),
        _buildTextField(_engineController, 'Engine Number', 'Last 6 digits', Icons.engineering),
        const SizedBox(height: 20),
        _buildTextField(_chassisController, 'Chassis Number', 'Last 6 digits', Icons.minor_crash),
        const Spacer(),
